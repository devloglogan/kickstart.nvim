...
vim.opt.conceallevel = 1 -- Allow concealing (for markdown mostly)
vim.opt.concealcursor = 'n' -- Allow concealing on cursor line in normal mode
...
require('lazy').setup({
  ...
  -- TODO: Might require nvim cmp for autocomplete
  {
